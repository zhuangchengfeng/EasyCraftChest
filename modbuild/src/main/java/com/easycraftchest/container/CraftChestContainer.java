 ...
 */
package com.easycraftchest.container;

import com.easycraftchest.CraftChestMod;
...
public class CraftChestContainer
extends AbstractContainerMenu {
    private final BlockPos blockPos;
    private final Container dummyContainer;

    public CraftChestContainer(int containerId, Inventory playerInventory, BlockPos pos) {
        super(CraftChestMod.CRAFT_CHEST_MENU.get(), containerId);
        this.blockPos = pos;
