 ...
 * 数据全局一份,不随存档分开。JSON:config/automatic-crafting_synthesis_stats.json
 */
public final class SynthesisStats {
    ...
    private static final File FILE = FMLPaths.CONFIGDIR.get().resolve("automatic-crafting_synthesis_stats.json").toFile();
